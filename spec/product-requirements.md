...
- FR-14 Break-out (`ctrl+shift+q`, also `/interrogate` toggles): suspends the panel; main editor becomes available; drafts and panel state preserved; widget shows open/answered counts and resume key. Resume focuses the first unanswered question.
